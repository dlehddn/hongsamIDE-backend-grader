...
public class LambdaRunController implements Function<UserRunRequest, UserRunResponse> {
    ...
    public UserRunResponse apply(UserRunRequest userRunRequest) {
        ...
        try {
            // 3. input.txt, answer.txt 파일 가져오기
            javaCompilerService.loadInAnsFile(userRunRequest.getQuestionId());
            ...
            if (userRunResponse.getResult() == null) {
                ...
                // 정답 반환
                return javaCompilerService.compareFiles(userRunResponse,"C:\\Users\\Seoyeon\\Desktop\\홍삼\\hongsamIDE-backend-grader\\run\\src\\main\\java\\store\\output.txt",
                        "C:\\Users\\Seoyeon\\Desktop\\홍삼\\hongsamIDE-backend-grader\\run\\src\\main\\java\\store\\answer.txt");
            }
